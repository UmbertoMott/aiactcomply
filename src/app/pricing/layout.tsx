...
export const metadata: Metadata = {
  title: "Prezzi AIComply — Piani per la Conformità EU AI Act",
  description:
    "Scegli il piano AIComply adatto alla tua azienda. Dal piano gratuito per PMI al piano Enterprise per provider di sistemi AI ad alto rischio. Conformità EU AI Act a partire da 0€.",
  openGraph: {
