...
{ "identification": { "riskEntries": [ { "id": "R-01", "category": "...", "description": "...", "art9Reference": "Art. 9(2)(a)", "likelihood": "low|medium|high", "impact": "low|medium|high", "mitigations": "...", "owner": "...", "status": "open", "nextReviewDate": "2026-09-01" } ], "vulnerableGroupsImpactAssessment": "Valutazione impatto su minori e gruppi vulnerabili: ..." } }`,

  estimation: `Stai guidando lo STEP 3 — STIMA E VALUTAZIONE (Art. 9(2)(b) AI Act).
...
{ "estimation": { "intendedUseCases": ["..."], "foreseenMisuse": ["..."], "impactAssessment": "...", "affectedPersonsCount": "...", "evaluationAgainstCriteria": "..." } }`,
  ...
  testing: `Stai guidando lo STEP 4 — TEST E VALIDAZIONE (Art. 9(6)-(8) AI Act).
...
{ "testing": { "testMetrics": ["accuratezza >90%", "..."], "thresholds": "...", "validationOutcome": "...", "worstCase": "...", "confidenceLevel": "..." } }`,
  ...
  mitigation: `Stai guidando lo STEP 5 — TRATTAMENTO DEL RISCHIO E RISCHIO RESIDUO (Art. 9(2)(d), 9(4)-(5) AI Act; supporto Art. 13).
...
{ "mitigation": { "treatmentOption": "Modifica|Evitamento|Condivisione|Ritenzione", "measures": ["..."], "residualRisk": "...", "responsiblePerson": "...", "reviewCycle": "..." } }`,
  ...
  monitoring: `Stai guidando lo STEP 6 — MONITORAGGIO POST-MARKET E DRIFT DETECTION (Art. 9(2)(c) AI Act; supporto Art. 72).
...
{ "monitoring": { "monitoringFrequency": "...", "alertThreshold": "PSI > 0.2", "postMarketPlan": "...", "reviewLog": [ { "date": "2026-06-13", "trigger": "pianificata", "outcome": "...", "reviewer": "...", "nextReviewDate": "2026-09-13" } ] } }`,
  ...
  gap_check: `Stai guidando lo STEP 7 — VERIFICA DI COPERTURA ART. 9 (Art. 9(2)(a)-(d), 9(6)-(8), 9(9) AI Act).
...
Includi <extract>:
{ "gap_check": { "coverageScore": 75, "assessment": "...", "missingAreas": [ { "area": "...", "art9Requirement": "Art. 9(2)(c)", "suggestedRiskTitle": "...", "priority": "obbligatorio" } ] } }`,

  traceability: `Stai guidando lo STEP 8 — TRACCIABILITÀ E MANTENIMENTO CONTINUO (Art. 9(1)-(2) AI Act; supporto Art. 12, 17).
...
{ "communication": { "stakeholdersInvolved": "...", "friaLink": "FRIA compilata / non applicabile / link", "externalConsultees": "...", "consultationDocumented": true } }`,
  ...
  gpai_systemic_risk: `Stai guidando il MODULO CONDIZIONALE — GPAI & RISCHIO SISTEMICO (Art. 51-55 Capo V AI Act).
