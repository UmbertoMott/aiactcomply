...
export const MEASURE_IMPLEMENTATION_TYPE_LABELS: Record<string, string> = {
  provider_built_in:     "Integrata dal provider — Art. 14(3)(a)",
  deployer_implemented:  "Da implementare dal deployer — Art. 14(3)(b)",
