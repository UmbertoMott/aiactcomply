...
export const KNOWN_SYSTEMS: KnownSystemProfile[] = [
  {
    ...
    tierBasisHint: "Annex III(4)(a) — employment, recruitment/selection of natural persons",
  ...
  },
  {
    ...
    typicalRole: "deployer",
    typicalTier: "high_risk",
    tierBasisHint: "Annex III(4)(a) — employment, recruitment, evaluation during selection",
  ...
  },
  {
    ...
    typicalRole: "deployer",
    typicalTier: "minimal",
    tierBasisHint: "Assistente alla scrittura di codice — nessuna delle categorie Annex III, nessuna pratica Art. 5",
  ...
  },
  {
    ...
    typicalRole: "deployer",
    typicalTier: "limited",
    tierBasisHint: "Dipende dal modulo: lead scoring = potenzialmente high-risk se decisioni su credito/assicurazione. CRM standard = limited/minimal",
  ...
  },
  {
    ...
    typicalRole: "deployer",
    typicalTier: "gpai",
    tierBasisHint: "GPAI — modello general purpose con capacità generiche su ampio range di task. Art. 51 EU AI Act",
  ...
  },
  {
    ...
    typicalRole: "deployer",
    typicalTier: "high_risk",
    tierBasisHint: "Annex III(4) — employment, worker management, task allocation if AI-driven",
  ...
  },
  {
    ...
    tierBasisHint: "Dipende dall'applicazione — classificare in base all'use case specifico, non al modello base",
