// Shared risk patterns — single source of truth for ai-risk-scorer.ts and inference.ts.
// Any change to patterns must happen here only.
...
export const RISK_PATTERNS: RiskPattern[] = [
  ...
  {
    id: "PATTERN_EMOTION_001",
    legal_reference: "Article 5(1)(f) - Emotion Recognition in Workplace / Education",
    technical_indicators: {
      libraries: ["deepface", "fer", "emopy", "affectnet", "mediapipe", "opencv-python"],
      keywords: [
        "emotion_recogn", "emotion_detect", "affect_recogn", "facial_action",
        "mood_detect", "sentiment_face", "employee_emotion", "student_emotion",
        "workplace_affect", "classroom_monitor",
      ],
      api_endpoints: ["/detect-emotion", "/analyze-affect", "/mood-score", "/emotion-classify"],
    },
    risk_level: "Unacceptable",
    weight: 100,
    validation_logic: "IMMEDIATE_BLOCK",
    description: "Riconoscimento emozioni in contesti lavorativi o educativi — vietato da Art. 5(1)(f) in vigore dal 2 agosto 2025",
  },
  {
    id: "PATTERN_JUSTICE_001",
    legal_reference: "Annex III, Point 8 - Administration of Justice & Democratic Processes",
    technical_indicators: {
      libraries: ["scikit-learn", "xgboost", "lightgbm", "transformers", "torch"],
      keywords: [
        "recidivism", "recidiva", "sentence_predict", "bail_assess", "risk_assess_criminal",
        "judicial_decision", "court_predict", "legal_outcome", "parole_risk",
        "justice_score", "case_outcome", "verdict_predict",
      ],
      api_endpoints: ["/predict-recidivism", "/assess-risk", "/judicial-score", "/legal-predict"],
      data_schema_hints: ["prior_offenses", "criminal_history", "risk_score", "recidivism_label"],
    },
    risk_level: "High",
    weight: 90,
    validation_logic: "TRIGGER_IF_ALL_MATCH",
    description: "Sistemi AI a supporto di decisioni giudiziarie o amministrazione della giustizia — Allegato III punto 8. Zona grigia: High se usato da autorità giudiziaria, Limited se uso privato/legal tech",
  },
  {
    id: "PATTERN_EMP_001",
    ...
    technical_indicators: {
      ...
      keywords: [
        "resume_parser", "candidate_score", "hiring_rank", "cv_extraction",
        "candidate_screening", "applicant_tracking", "employee_monitoring", "performance_predict",
      ],
      api_endpoints: [],
  ...
  },
  {
    ...
    description: "Generazione contenuti sintetici — obblighi marcatura Art. 50(2)",
  },
];
