...
export const ROBUSTNESS_ITEMS = [
  { id: "ood_degradation",  label: "Degrado sotto perturbazione / dati out-of-distribution", reference: "Art. 15(4) [Reg. (UE) 2024/1689]" },
  { id: "fault_tolerance",  label: "Fault tolerance / ridondanza / fail-safe",               reference: "Art. 15(4) [Reg. (UE) 2024/1689]" },
  { id: "feedback_loops",   label: "Misure contro i feedback loop (apprendimento continuo)",  reference: "Art. 15(4) [Reg. (UE) 2024/1689]" },
] as const;
